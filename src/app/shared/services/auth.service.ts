...
export class AuthService {
    ...
    login(userLogin: IUserLogin) {
        ...
        return this.http.post(this.serviceBase + 'login', postBody, this.httpUtils.getJsonRequestOptions())
            .map((res: Response) => {
    ...
    logout() {
        return this.http.post(this.serviceBase + 'logout', null, this.httpUtils.getJsonRequestOptions())
            .map((res: Response) => {
